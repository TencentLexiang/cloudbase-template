...
const createdHook = async (company_id) => {
  return await createCompany(company_id);
}

const createCompany = async (company_id) => {
  // todo your createHook
}
